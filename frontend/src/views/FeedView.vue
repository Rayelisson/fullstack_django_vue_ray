    ...
    <div class="main-center col-span-2 space-y-4">
      <div class="bg-white border border-gray-200 rounded-lg">
        ...
        <div class="p-4 border-t border-gray-100 flex justify-between">
          ...
          <a href="#" class="inline-block py-4 px-6 bg-purple-600 text-white rounded-lg"
            >Post</a
          >
          Hello Test
        </div>
      ...
      <!--<div class="p-4 bg-white border border-gray-200 rounded-lg">
        <div class="mb-6 flex items-center justify-between">
          <div class="flex items-center space-x-6">
            <img
              src="https://images.pexels.com/photos/2097475/pexels-photo-2097475.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      ...
      <div class="p-4 bg-white border border-gray-200 rounded-lg">
        <div class="mb-6 flex items-center justify-between">
          <div class="flex items-center space-x-6">
            ...
            <p>
              <strong>{{ posts.created_by }}</strong>
            </p>
          </div>
